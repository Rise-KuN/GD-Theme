...
function nav(path) {
  ...
  `;
  html += `<div class="mdui-container"><div class="mdui-row"><a href="/" dir=auto class="mdui-typo-headline folder">${document.siteName}</a>`;
